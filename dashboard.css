...
.sidebar nav ul li a {
    color: #e0e0e0; /* Off-white for general links */
...
.sidebar nav ul li a.active {
    background-color: rgba(255, 255, 255, 0.2); /* More prominent white overlay for active */
    color: #ffffff;
    box-shadow: inset 3px 0 0 0 #2575fc; /* Vibrant blue accent on left */
}
...
.action-button, .submit-button, .primary-button {
...
body.dark-mode .sidebar ul li a {
    color: #e0e0e0; /* Light link text in sidebar */
}

body.dark-mode .sidebar ul li a:hover {
    background-color: #404040; /* Darker hover background */
}
