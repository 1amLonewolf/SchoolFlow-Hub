...
document.addEventListener('DOMContentLoaded', () => {
    ...
    loginForm.addEventListener('submit', async (event) => {
        ...
        try {
            ...
            setTimeout(() => {
                // This transition makes the login box itself fade out and shrink
                loginBox.style.opacity = '0';
                loginBox.style.transform = 'scale(0.8)';

                // Second setTimeout: After login box fades, redirect.
                // Removed the document.body.innerHTML manipulation here.
                setTimeout(() => {
                    window.location.href = 'dashboard.html';
                }, 800); // Wait for loginBox transition (0.8s) before redirecting

            }, 1000); // Show "Login Successful!" for 1 second before starting fade out
